...
*/	  	
   //$sql = sprintf( " 
   //		,$likeClause );  	
     $sql = "select recipe.id as rid, recipe.name as title, 
		 content as contents, category.name as category
		 FROM recipe, category WHERE recipe.category_id = category.id"; 
